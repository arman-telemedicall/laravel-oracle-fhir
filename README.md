...
```php
$accessToken = $oracle->systemAccessToken($clientId, $tenantId);
$smartAccessToken = $oracle->smartAccessToken($clientId, $tenantId, 'owner1');
```
...
Oracle sandbox: https://fhir.oracle.com/
